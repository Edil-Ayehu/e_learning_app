...
class AnalyticsService {
  ...
  Future<AnalyticsData> updateLearningStreak(
    ...
    final longestStreak = currentStreak > currentAnalytics.learningStreak['longest']! 
        ? currentStreak 
  ...
  Future<AnalyticsData> updateSkillProgress(
    ...
    await Future.delayed(const Duration(milliseconds: 500));
    final updatedSkillProgress = Map<String, double>.from(currentAnalytics.skillProgress);
