...
class LessonVideoController {
  ...
  Future<void> initializeVideo() async {
    try {
      ...
      videoPlayerController = VideoPlayerController.network(lesson.videoStreamUrl);
      await videoPlayerController?.initialize();
      videoPlayerController?.addListener(() => onVideoProgressChanged(courseId));
  ...
  void onVideoProgressChanged(String courseId) {
    if (videoPlayerController != null &&
      ...
      videoPlayerController?.removeListener(() => onVideoProgressChanged(courseId));
    }
  }
